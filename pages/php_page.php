...
<head>
    <meta charset="UTF-8">
    <meta name="keywords" content="notatki, algorytmy, matematyka, sql, java, php">
    <title>PHP</title>
...
<header>
    ...
    <div class="container-fluid">
        <ul class="nav nav-tabs">
            ...
            <li class="nav-item">
                <a class="nav-link active btn-outline-light btn-lg" aria-current="page" href="php_page.php"
                   role="button">PHP</a>
            </li>
        </ul>
    </div>
    <iframe src="../assets/PHP.pdf" width="100%" height="600px">
    </iframe>
